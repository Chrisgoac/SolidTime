...
def registro_entrada(dni):
    ...
    if datos[0][2] == "entrada":
        print("No se puede generar un registro de entrada ya que el último registro existente que tiene su usuario es un registro de entrada.")
    else:
...
def registro_salida(dni):
    ...
    datos = cursor.fetchall()
    if datos[0][2] == "salida":
        print("No se puede generar un registro de salida ya que el último registro existente que tiene su usuario es un registro de salida.")
    else:
